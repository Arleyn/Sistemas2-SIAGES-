...
db.define_table('Unidad_metrica',
    Field('nombre_unidadMetrica', unique=True, length=20, requires=IS_NOT_EMPTY(),
          label='(*) Nombre Unidad Métrica'),
    Field('nomenclatura', unique=True, length=10, requires=IS_NOT_EMPTY(), label='(*)Nomenclatura' ),
...
db.define_table('Edificio',
    Field('nombre_edificio', unique=True, length=60, requires=IS_NOT_EMPTY(), label='(*) Edificio' ),
    Field('nomenclatura', length=5, requires=IS_NOT_EMPTY(), label='(*)Nomenclatura'),
    Field('estado', requires=IS_IN_SET(['Inactivo','Activo'], error_message='Elija uno de las estados.', ),
          label='(*) Estado' ),
...
db.define_table('Area',
    Field('nombre_area', unique=True, length=60, requires=IS_NOT_EMPTY(), label='(*) Area' ),
    Field('nomenclatura', unique=True, length=5, requires=IS_NOT_EMPTY(), label='(*)Nomenclatura' ),
    Field('estado', requires=IS_IN_SET(['Inactivo','Activo'], error_message='Elija uno de las estados.'),
          label='(*) Estado' ),
...
db.define_table('Unidad',
   Field('nombre_unidad', unique=True, length=60, requires=IS_NOT_EMPTY(), label='(*) Unidad' ),
   Field('estado', requires=IS_IN_SET(['Inactivo','Activo'], error_message='Elija uno de las estados.'),
          label='(*) Estado' ),
...
db.define_table('Status_solicitud',
   Field('nombre_status', unique=True, length=20, requires=IS_NOT_EMPTY(), label='(*) Estatus' ),
   Field('estado', requires=IS_IN_SET(['Inactivo','Activo'], error_message='Elija uno de las estados.'),
          label='(*) Estado' ),
...
db.define_table('Prioridad',
   Field('nombre_prioridad', unique=True, length=20, requires = IS_NOT_EMPTY(), label='(*) Prioridad'  ),
   Field('estado', requires=IS_IN_SET(['Inactivo','Activo'], error_message='Elija uno de las estados.'),
          label='(*) Estado' ),
